    ...
    <div className="flex h-screen bg-background">
      ...
      <aside className={`${sidebarOpen? 'w-64' : 'w-20'} bg-card border-r border-border transition-all duration-300 flex flex-col`}>
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-border">
          {sidebarOpen? (
            <span className="text-foreground font-bold text-xl">Parkroo</span>
          ) : (
            <span className="text-foreground font-bold text-xl">PR</span>
          )}
          <button
          ...
          {sidebarOpen && name && (
            <div className="flex items-center gap-2 px-2 py-1">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground">Parking Owner</p>
              </div>
            </div>
          )}
          <button
            onClick={handleLogout}
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors ${
